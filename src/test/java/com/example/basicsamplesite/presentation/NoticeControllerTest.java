...
import com.example.basicsamplesite.presentation.dto.NoticeCreateDto;
...
class NoticeControllerTest {
    ...
    void getAllNotices_ShouldReturnAllNotices() throws Exception {
        // given
        NoticeSummaryResponse notice1 = new NoticeSummaryResponse(1L, "공지사항 1", LocalDateTime.now(), 5);
        NoticeSummaryResponse notice2 = new NoticeSummaryResponse(2L, "공지사항 2", LocalDateTime.now(), 10);
        ...
        mockMvc.perform(get("/api/notices"))
                ...
                .andExpect(jsonPath("$.data[1].title").value("공지사항 2"))
    ...
    void getNoticeById_ShouldReturnNotice() throws Exception {
        ...
        NoticeDetailResponse notice = new NoticeDetailResponse(
                noticeId, "공지사항 제목", "공지사항 내용", createdAt, 5);
    ...
    void createNotice_ShouldCreateAndReturnCreated() throws Exception {
        // given
        NoticeCreateDto requestDto = new NoticeCreateDto("새 공지사항", "새 공지사항 내용");
        ...
        mockMvc.perform(post("/api/notices")
                ...
                .andExpect(jsonPath("$.data.title").value("새 공지사항"))
                .andExpect(jsonPath("$.data.message").value("공지사항이 성공적으로 생성되었습니다."))
    ...
    void createNotice_WithInvalidRequest_ShouldReturnBadRequest() throws Exception {
        // given
        NoticeCreateDto request = new NoticeCreateDto("", ""); // 빈 제목과 내용
    ...
    void createNotice_WhenServerError_ShouldReturnBadRequest() throws Exception {
        // given
        NoticeCreateDto request = new NoticeCreateDto("새 공지사항", "새 공지사항 내용");
        ...
        mockMvc.perform(post("/api/notices")
                ...
                .andExpect(jsonPath("$.message").value("공지사항 생성 실패: 공지사항 생성에 실패했습니다."));
